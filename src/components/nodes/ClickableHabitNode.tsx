...
const ClickableHabitNode = memo(({ data, selected, id }: ClickableHabitNodeProps) => {
  ...
  const getNodeStyle = () => {
    ...
    if (isInactive)
      return 'border-gray-300 bg-gray-100 text-gray-500 cursor-pointer opacity-60 hover:opacity-80'
    if (isCompleted)
      return 'border-green-500 bg-green-50 text-green-800 cursor-pointer hover:bg-green-100'
