...
const NodeInfoPanel = memo(
  ({
    ...
    return (
      <>
        {/* 動的な矢印コネクター */}
        <ArrowConnector panelRef={panelRef} targetNodeId={selectedNode.id} position={position} />
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-gray-600">
              ...
              {selectedNode.type === 'habit' && <div>状態: {getNodeStatus()}</div>}
            </div>
          </div>
