...
describe('NodeEditor', () => {
  ...
  it('should not be visible initially', () => {
    render(<NodeEditor node={null} isOpen={false} onClose={vi.fn()} onSave={vi.fn()} />)

    expect(screen.queryByRole('dialog')).not.toBeInTheDocument()
  })

  it('should show edit modal when node is provided and isOpen is true', () => {
    render(<NodeEditor node={mockNode} isOpen={true} onClose={vi.fn()} onSave={vi.fn()} />)
  ...
  it('should close modal when cancel button is clicked', async () => {
    ...
    render(<NodeEditor node={mockNode} isOpen={true} onClose={mockOnClose} onSave={vi.fn()} />)
  ...
  it('should call onSave with updated data when form is submitted', async () => {
    ...
    render(<NodeEditor node={mockNode} isOpen={true} onClose={vi.fn()} onSave={mockOnSave} />)
